...
function game() {
    ...
    this.generateNewMaze = function(size, floorTextureName, wallTextureName,
        ...
        var _floor = new THREE.Mesh(
            ...
            new THREE.MeshPhongMaterial({
                //map: this.textures[floorTextureName],
        ...
        var _ceil = new THREE.Mesh(
            ...
            new THREE.MeshPhongMaterial({
              color: 0xeeeeee
                //map: this.textures[ceilTextureName],
  ...
  */
    ...
    this.generateNewPlayer = function() {
        ...
        this.playerLight = new THREE.HemisphereLight( '#FFFFFF', '#EEEEEE', .75 );
        this.playerLight.position.set( 0.5, 10, 10 );
...
function wouldPlayerCollideWithMaze(direction, distance) {
    ...
    return (colliders.length > 0 && colliders[0].distance < distance+2.5);
}
